...
def home():
    ...
    <body>
        <div class="container">
            <h1 style="color: #003366;">WELCOME TO THE HOME PAGE</h1>
            <ul>
...
def add():
    ...
    <body>
        <div class="container">
            <h1 style="color: #003366;">Add Product Page</h1>
...
def remove():
    ...
    <body>
        <div class="container">
            <h1 style="color: #003366;">Remove Product Page</h1>
...
def update():
    ...
    <body>
        <div class="container">
            <h1 style="color: #003366;">Update Product Page</h1>
